...
from src.common.database.connection import get_db_connection, return_db_connection
...
class NotionPageOperations:
    ...
    def get_page_by_id(page_id: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            query = "SELECT * FROM notion_pages WHERE page_id = %s AND deleted_at IS NULL"
    ...
    def search_similar_pages(
        ...
        try:
            ...
            cursor.execute(query, (embedding, embedding, similarity_threshold, embedding, limit))
